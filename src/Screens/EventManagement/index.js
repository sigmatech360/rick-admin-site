...
export const EventManagement = () => {
  ...
  const removeItem = ( ) => {
    const LogoutData = localStorage.getItem("login");
    document.querySelector(".loaderBox").classList.remove("d-none");
    fetch(`${apiUrl}/api/admin/event/${handledeleteid}`, {
      method: "DELETE",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
    ...
    <>
      <DashboardLayout>
        <div className="container-fluid">
          ...
          <CustomModal show={showModal5} close={() => { setShowModal5(false) }} action={() => { setShowModal5(false); removeItem() }} heading={" Do you want to delete this event?"} />
