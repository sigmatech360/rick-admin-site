...
export const AnnouncementManagement = () => {
  ...
  const Deleteannouncement = ( ) => {
    const LogoutData = localStorage.getItem("login");
    document.querySelector(".loaderBox").classList.remove("d-none");
    fetch(`${apiUrl}/api/admin/announcement/${handledeleteid}`, {
      method: "DELETE",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
    ...
    <>
      <DashboardLayout>
        <div className="container-fluid">
                          ...
                          <tr key={index}>
                            ...
                            <td>
                              <Dropdown className="tableDropdown">
                                ...
                                >
                                  <Link
                                    to={`/announcement-management/announcement-details/${item?.id}`}
                                  ...
                                  <Link
                                    to={`/announcement-management/edit-announcement/${item?.id}`}
                                    className="tableAction"
                                  >
                                    <FontAwesomeIcon
                                      icon={faEdit}
          ...
          <CustomModal show={showModal5} close={() => { setShowModal5(false) }} action={() => { setShowModal5(false); Deleteannouncement() }} heading={" Do you want to delete this announcement?"} />
        </div>
      </DashboardLayout>
    </>
  );
