...
export const SponsoredProgram = () => {
  ...
  const projectlist = () => {
    ...
    fetch(`${apiUrl}/api/admin/sponsored-program`, {
      method: 'GET',
      headers: {
  ...
  const Deleteproject = ( ) => {
    const LogoutData = localStorage.getItem("login");
    document.querySelector(".loaderBox").classList.remove("d-none");
    fetch(`${apiUrl}/api/admin/sponsored-program/${handledeleteid}`, {
      method: "DELETE",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
    ...
    <>
      <DashboardLayout>
        <div className="container-fluid">
              ...
              <div className="dashCard">
                <div className="row mb-3 justify-content-between">
                  <div className="col-md-6 mb-2">
                    <h2 className="mainTitle">Sponsor Program</h2>
                  </div>
                  <div className="col-md-6 mb-2">
          ...
          <CustomModal show={showModal5}   close={() => { setShowModal5(false) }} action={() => { setShowModal5(false); Deleteproject() }}   heading={" Do you want to delete this Program ?"} />
        </div>
      </DashboardLayout>
    </>
  );
